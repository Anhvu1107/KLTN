...
const PRODUCT_TEMPLATES = [
    { name: 'Geobasket Sneakers', category: 'Shoes', basePrice: 1200 },
    { name: 'Bomber Jacket', category: 'Outerwear', basePrice: 2500 },
    { name: 'Draped Trousers', category: 'Pants', basePrice: 800 },
    { name: 'Oversized Hoodie', category: 'Tops', basePrice: 600 },
    { name: 'Leather Tote Bag', category: 'Bags', basePrice: 1500 },
    { name: 'Wool Overcoat', category: 'Outerwear', basePrice: 3000 },
    { name: 'Silk Shirt', category: 'Tops', basePrice: 450 },
    { name: 'Wide-Leg Trousers', category: 'Pants', basePrice: 700 },
    { name: 'Platform Boots', category: 'Shoes', basePrice: 1400 },
    { name: 'Crossbody Bag', category: 'Bags', basePrice: 900 },
    { name: 'Deconstructed Blazer', category: 'Outerwear', basePrice: 1800 },
    { name: 'Knit Sweater', category: 'Tops', basePrice: 550 },
    { name: 'Technical Pants', category: 'Pants', basePrice: 950 },
    { name: 'Gore-Tex Jacket', category: 'Outerwear', basePrice: 2200 },
    { name: 'Backpack', category: 'Bags', basePrice: 1100 },
    { name: 'Canvas Sneakers', category: 'Shoes', basePrice: 500 },
    { name: 'Asymmetric Dress', category: 'Dresses', basePrice: 1300 },
    { name: 'Cashmere Cardigan', category: 'Tops', basePrice: 800 },
    { name: 'Cargo Pants', category: 'Pants', basePrice: 650 },
    { name: 'Leather Belt', category: 'Accessories', basePrice: 350 },
];
...
Remember: Every piece tells a story. Help customers discover theirs.`,
    ...
    await db.SystemPrompt.create({
        ...
        content: 'Welcome to AURA ARCHIVE! I\'m your personal stylist. How may I help you discover your next statement piece today?',
