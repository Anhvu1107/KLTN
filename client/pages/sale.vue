  ...
  <div>
    ...
    <div class="bg-gradient-to-br from-red-600 to-rose-700 text-white">
      <div class="container-aura py-16 lg:py-24 text-center">
        ...
        <p class="text-body text-red-100 max-w-2xl mx-auto">
          Exceptional savings on authenticated luxury pieces. Don't miss these limited-time offers.
        </p>
        <p v-if="products.length" class="text-body-sm text-red-200 mt-4">
          {{ products.length }} {{ t('shop.products') }} on sale
        </p>
      </div>
    </div>
    ...
    <div class="container-aura py-12 lg:py-16">
      ...
      <div v-else-if="products.length === 0" class="text-center py-20">
        ...
        <h3 class="font-serif text-heading-4 text-aura-black mb-2">No Sale Items</h3>
        <p class="text-body text-neutral-500 mb-6">Check back soon for exclusive deals</p>
