  ...
  <div>
    ...
    <div class="bg-gradient-to-b from-neutral-900 to-neutral-800 text-white">
      <div class="container-aura py-16 lg:py-24 text-center">
        ...
        <p class="text-body text-neutral-300 max-w-2xl mx-auto">
          Hand-picked pieces chosen by our expert curators for their exceptional quality and timeless appeal.
        </p>
      </div>
    </div>
    ...
    <div class="container-aura py-12 lg:py-16">
      ...
      <div v-else-if="products.length === 0" class="text-center py-20">
        ...
        <h3 class="font-serif text-heading-4 text-aura-black mb-2">No Featured Products</h3>
        <p class="text-body text-neutral-500 mb-6">Check back soon for our curated picks</p>
