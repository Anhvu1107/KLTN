...
const contactInfoItems = computed(() => [
  { key: 'address', label: t('contact.addressLabel'), value: contactAddress.value, href: '' },
  {
    key: 'phone',
    label: t('contact.phoneLabel'),
    value: contactPhone.value,
    href: `tel:${contactPhone.value.replace(/[^\d+]/g, '')}`,
  },
  {
    key: 'email',
  ...
  { key: 'hours', label: t('contact.hours'), value: t('contact.hoursValue'), href: '' },
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div class="space-y-8">
                <div>
                  ...
                  <div class="space-y-6">
                    <div v-for="item in contactInfoItems" :key="item.key">
                      <h3 class="text-body font-medium text-aura-black mb-2">{{ item.label }}</h3>
                      <a
                        v-if="item.href"
                        :href="item.href"
                        class="text-body text-neutral-600 hover:text-aura-black transition-colors"
                      >
                        {{ item.value }}
                      </a>
                      <p v-else class="text-body text-neutral-600 whitespace-pre-line">{{ item.value }}</p>
                    </div>
                  </div>
                </div>

                <!-- Social Links -->
                <div v-if="contactSocialLinks.length">
                  ...
                  <div class="flex gap-4">
                    <a
                      ...
                      class="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center hover:bg-neutral-200 transition-colors"
