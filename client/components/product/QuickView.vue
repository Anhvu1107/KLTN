        ...
        <div class="relative bg-white max-w-3xl w-full max-h-[90vh] overflow-hidden rounded-sm shadow-2xl">
          ...
          <div class="grid md:grid-cols-2 gap-6 p-6 overflow-y-auto max-h-[90vh]">
            ...
            <div class="flex flex-col">
              ...
              <!-- Size Selection -->
              <div class="mb-4">
                <p class="text-body-sm font-medium text-aura-black mb-2">Size</p>
              ...
              <!-- Color Selection -->
              <div class="mb-6">
                <p class="text-body-sm font-medium text-aura-black mb-2">Màu sắc</p>
                <div class="flex flex-wrap gap-2">
                  <button
              ...
              <div v-if="selectedVariant" class="mb-6">
                ...
                >
                  {{ selectedVariant.status === 'AVAILABLE' ? 'Còn hàng' : 'Hết hàng' }}
                </span>
              </div>
